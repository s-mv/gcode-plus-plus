...
public:
  ...
  constexpr uniform_integer_distribution(IntegerType a, IntegerType b)
      : m_a(transposeTo(a)), m_ab_distance(computeDistance(a, b)),
...
public:
  ...
  uniform_floating_point_distribution(FloatType a, FloatType b)
      : m_a(a), m_b(b), m_ulp_magnitude(Detail::gamma(m_a, m_b)),
        m_floats_in_range(
...
public:
  ...
  class const_iterator {
    ...
    const_iterator(Column const &column, EndTag)
        : m_column(column), m_lineStart(m_column.m_string.end()),
          m_lineEnd(column.m_string.end()), m_parsedTo(column.m_string.end()) {}
