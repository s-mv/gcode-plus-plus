...
void Sterp::active_g_codes(int gees[ACTIVE_G_CODES]) { std::fill(gees, gees + ACTIVE_G_CODES, 0); }
void Sterp::active_m_codes(int emms[ACTIVE_M_CODES]) { std::fill(emms, emms + ACTIVE_M_CODES, 0); }
void Sterp::active_settings(double sets[ACTIVE_SETTINGS]) { std::fill(sets, sets + ACTIVE_SETTINGS, 0.0); }
